...
### [10] | [A variable ADAF disk model for X-ray binary systems](http://arxiv.org/abs/2603.10311v1)
...
### [10] | [The Geometric Crisis in Cygnus~X-3: Limitations of Wind-Fed Accretion and the Case for Roche-Lobe Overflow](http://arxiv.org/abs/2603.10200v1)
...
### [10] | [Quantifying the impact of relativistic precession on tidal disruption event light curves](http://arxiv.org/abs/2603.10124v1)
...
### [9] | [Electromagnetic Signatures of Supermassive Binary Black Holes. I. Thermal Synchrotron, Self-Lensing Flares, and Jet Precession](http://arxiv.org/abs/2603.10792v1)
...
### [9] | [Magnetic field strength constraints on $γ$-ray flaring regions in the flat spectrum radio quasar PKS 1222+216](http://arxiv.org/abs/2603.10393v1)
...
### [9] | [A candidate proton cyclotron feature in the ultraluminous X-ray source NGC 4656 ULX-1](http://arxiv.org/abs/2603.10331v1)
...
### [9] | [Unexpectedly Weak General Relativistic Effects in Strongly Relativistic Tidal Disruption Events](http://arxiv.org/abs/2603.10208v1)
...
### [9] | [The X-ray weakness of Little Red Dots and JWST-selected AGN: comparison with local AGN in different accretion regimes](http://arxiv.org/abs/2603.10162v1)
...
### [9] | [The baryon content of magnetically arrested black hole disks and jets](http://arxiv.org/abs/2603.10122v1)
...
### [9] | [Geometric masking in AGN jets and its implications for unification and blazar physics](http://arxiv.org/abs/2603.04533v2)
...
### [7] | [Neutrinos from extreme astrophysical sources](http://arxiv.org/abs/2603.10167v1)
...
### [7] | [Accreting White Dwarfs: An Unreview](http://arxiv.org/abs/2603.10150v1)
...
### [7] | [Fast X-ray Transients produced by Off-axis Jet-Cocoons from Long Gamma-Ray Bursts](http://arxiv.org/abs/2603.09674v1)
...
### [6] | [Understanding the impact of binary mass transfer in the accretor's measurable parameters](http://arxiv.org/abs/2603.09776v1)
...
- **[4]** [Novae breves from magnetar giant flares: Potential probes of neutron star crusts](http://arxiv.org/abs/2603.10500v1)
  - *该论文研究了磁星巨耀发产生的短时光学暂现源（novae breves），探讨了其光变特征与中子星物态方程的关联及观测可行性。*
- **[4]** [Relativistic \(^{56}\text{Ni}\) Decay Lines in GRB 221009A](http://arxiv.org/abs/2603.10151v1)
  - *该研究通过分析GRB 221009A瞬时辐射中的高能谱线，提出其源于相对论性喷流中镍-56衰变的辐射。*
- **[4]** [XMM-Newton Observations of Flares and a Possible Pulse Dropout in the Supergiant X-ray binary 4U 1909+07](http://arxiv.org/abs/2603.10111v1)
  - *利用XMM-Newton观测分析了超巨星X射线双星4U 1909+07的自转周期演化、脉冲轮廓变化及脉冲消失现象。*
- **[3]** [White Dwarfs with Infrared Excess from LAMOST Data Release 11](http://arxiv.org/abs/2603.10481v1)
  - *利用LAMOST DR11数据筛选出139个具有红外超的白矮星候选体，包括白矮星与红矮星、褐矮星双星及尘埃盘系统。*
- **[3]** [Kick matters: The impact of a new recoil model on the retention of hierarchical black-hole remnants in globular clusters](http://arxiv.org/abs/2603.10170v1)
  - *该论文提出了一种新的黑洞并合反冲模型，分析了其对球状星团中分级黑洞并合残留物保留率及质量自旋分布的影响。*
- **[3]** [Joint Bayesian Source and Lens Reconstruction for Multi-messenger Binary Black Holes](http://arxiv.org/abs/2603.09794v1)
  - *该论文提出了一款名为silmarel的软件，用于联合分析引力波事件及其宿主星系的透镜效应，以识别多信使双黑洞系统。*
- **[2]** [Kinematics of Wolf-Rayet Stars in the LMC: Clues to Subtype Origins](http://arxiv.org/abs/2603.10826v1)
  - *利用Gaia DR3数据分析大麦哲伦云中沃尔夫-拉叶星的运动学特征，探讨其演化起源与动力学抛射机制。*
- **[2]** [Newly discovered Luminous blue variable candidates in M31 & M33](http://arxiv.org/abs/2603.10508v1)
  - *本文对M31和M33星系中的亮蓝变星候选体进行了光谱分析与分类，旨在扩充已知亮蓝变星样本。*
- **[2]** [Linear Mode Conversion in Ultramagnetized Pair Plasmas: Single-Parameter Scaling](http://arxiv.org/abs/2603.10226v1)
  - *本文提出了中子星磁层中超强磁化对偶等离子体线性模式转换的统一理论，解释了脉冲星与快速射电暴的偏振特征。*
- **[2]** [Comprehensive neutrino light curves and spectra: from pre-supernova evolution to early supernova phase](http://arxiv.org/abs/2603.09810v1)
  - *该论文系统研究了从大质量恒星演化末期到超新星爆发早期的中微子辐射特征及其与前身星物理参数的相关性。*
- **[2]** [Probing the Dispersion and Rotation Measure Contributions from Supernova Remnants in Fast Radio Burst Source Environments with 1D SNR Simulation](http://arxiv.org/abs/2603.07012v2)
  - *本文通过一维超新星遗迹模拟研究了快速射电暴（FRB）源区环境对色散量（DM）和旋转量（RM）的贡献。*
- **[1]** [Multi-wavelength emission modelling of PSR~J0437$-$4715](http://arxiv.org/abs/2603.10536v1)
  - *该论文通过多波段观测数据建模，研究了毫秒脉冲星PSR J0437-4715的磁场几何结构与辐射特性。*
- **[1]** [Kinematics and Untwisting Motion of an Intriguing Jet-like Prominence Eruption](http://arxiv.org/abs/2603.10534v1)
  - *本文研究了2023年10月6日发生的一次太阳喷流状日珥爆发的运动学特征、解扭转运动及等离子体振荡。*
- **[1]** [The fine dynamics in homologous and recurrent jets induced by persistent rising loops and mini-filaments](http://arxiv.org/abs/2603.10307v1)
  - *本文利用Solar Orbiter高分辨率观测研究了太阳大气中由上升环和微丝结构驱动的重复性喷流精细动力学过程。*
- **[1]** [The rotational and magnetic properties of Polaris from long-term spectropolarimetric monitoring](http://arxiv.org/abs/2603.09876v1)
  - *本文通过长期光谱偏振监测确定了造父变星北极星的自转周期及磁场特性，并探讨了其自转与轨道轴的倾角偏差。*
- **[1]** [The diagnostic temperature discrepancy as evidence for non-Maxwellian coronal electrons](http://arxiv.org/abs/2603.10040v1)
  - *该论文研究太阳日冕中电子温度诊断的差异，提出非麦克斯韦电子速度分布（kappa分布）以解释射电观测与流体模型的不一致性。*
- **[0]** [Catalogue and statistics of greater than 100 MeV solar proton events during solar cycles 23-25 from SOHO-ERNE observations](http://arxiv.org/abs/2603.10903v1)
  - *本文整理了第23至25太阳活动周期间的高能太阳质子事件目录，研究其与太阳耀斑及日冕物质抛射的关联。*
- **[0]** [Hinode EIS Observations of Plasma Composition Evolution and Radiative Cooling of Solar Flare Loops](http://arxiv.org/abs/2603.10643v1)
  - *本文利用Hinode卫星观测研究了太阳耀斑环中等离子体成分演化与辐射冷却过程的关系。*
- **[0]** [Neural Differential Equations for the Solar Dynamo](http://arxiv.org/abs/2603.10548v1)
  - *本文提出利用神经微分方程方法构建太阳发电机模型，以数据驱动方式优化太阳黑子周期中的阿尔法淬灭函数。*
- **[0]** [Chromospheric and photospheric properties of sunspots as inferred from Stokes inversions under magneto-hydrostatic and non-local-thermodynamic equilibrium](http://arxiv.org/abs/2603.10543v1)
  - *本文利用高分辨率光谱偏振数据，通过非局部热力学平衡反演研究了太阳黑子的色球层与光球层磁流体动力学特性。*
- **[0]** [Full Dynamical Model (SOCOL:14C-Ex) of 14C Atmospheric Production and Transport in Application to Miyake Events](http://arxiv.org/abs/2603.10345v1)

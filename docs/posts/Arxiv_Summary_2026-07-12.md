...
### [10] | [Physics and Astrophysics of Black Holes with eXTP](http://arxiv.org/abs/2607.09112v1)
...
### [10] | [In the Eye of the Storm: The Third Giant X-ray Outburst of the Extreme Changing-look AGN IC 3599](http://arxiv.org/abs/2607.09036v1)
...
### [10] | [A cooler look at the environment of Cygnus X-1: Searching for dynamical interactions within cold molecular gas](http://arxiv.org/abs/2607.08994v1)
...
### [10] | [Massive Perturbers and Transient Pickup Discs in Disc-Crossing Encounters in OJ 287-like Supermassive Black Hole Binaries](http://arxiv.org/abs/2607.08832v1)
...
### [10] | [Star-Disk Collisions II: Debris Stream Dynamics and Implications for QPEs and Other Transients Near SMBHs](http://arxiv.org/abs/2607.08823v1)
...
### [9] | [Hamiltonian variational reconstruction of the 3D magnetic geometry of relativistic jets: accuracy across GRMHD models and the fundamental sign degeneracy](http://arxiv.org/abs/2607.09569v1)
...
### [8] | [Studying the Variable Continuum and Emission Line Spectrum of 4U 1700-377 using NuSTAR's Stray Light](http://arxiv.org/abs/2607.08876v1)
...
### [6] | [Cataclysmic Variables Photometric Periods from TESS](http://arxiv.org/abs/2607.08727v2)
...
### [6] | [The Recurrent Nova TCrB: A Method for Predicting the Next Eruptive Event in Nova Cycles](http://arxiv.org/abs/2607.05200v2)
...
- **[3]** [Periodic line-of-sight velocity-driven modulations to gravitational waves emitted by compact binaries in Keplerian outer orbits](http://arxiv.org/abs/2607.09644v1)
  - *该论文研究了致密双星在超大质量黑洞附近运动时，因视向速度周期性变化导致的引力波波形调制及参数约束。*
- **[2]** [Identifying and characterizing extragalactic circum-CBC exoplanets with future gravitational-wave detectors](http://arxiv.org/abs/2607.09658v1)
  - *本文探讨了利用未来引力波探测器通过分析致密双星并合过程中的质心晃动效应，探测河外致密双星系统周围系外行星的方法。*
- **[2]** [Neutron contribution to the force on a proton vortex in superconducting neutron-star matter](http://arxiv.org/abs/2607.09468v1)
  - *本文利用朗道费米液体理论研究了中子星内部超导质子涡旋受到的中子散射力。*
- **[2]** [Star Clusters in the Ultraviolet](http://arxiv.org/abs/2607.08917v1)
  - *本文综述了紫外波段在研究星团恒星演化、致密天体及双星相互作用方面的应用与进展。*
- **[2]** [The SPOTLIGHT Pulsar Search Pipeline: A GPU-Accelerated FFT Approach](http://arxiv.org/abs/2607.08854v1)
  - *本文介绍了一种基于uGMRT的GPU加速脉冲星搜索流水线，旨在实现大规模射电暂现源与脉冲星的实时探测。*
- **[2]** [Hybrid Simulations of Proton Acceleration at Oblique High-$β$ Shocks](http://arxiv.org/abs/2607.08835v1)
  - *本文通过混合模拟研究了星系团介质中斜激波对质子的加速效率，揭示了磁倾角与马赫数对宇宙线加速的关键影响。*
- **[2]** [SN 2022erq: A Superluminous Thermonuclear Supernova with Escalating Pre-Explosion Mass Loss](http://arxiv.org/abs/2607.06338v2)
  - *本文研究了Ia-CSM型超新星SN 2022erq，通过光变与光谱分析揭示了其前身星系统存在剧烈的质量损失过程。*
- **[1]** [The significance of first post-adiabatic contributions for scalar charge measurements with intermediate and extreme mass ratio inspirals](http://arxiv.org/abs/2607.09310v1)
  - *该论文研究了中等与极端质量比旋近系统在标量场引力理论下的波形建模及其对标量荷测量精度的影响。*
- **[1]** [In-medium hyperon potentials and the quarkyonic hyperon onset: charged $Σ$'s in $β$-equilibrium and the neutrino connection](http://arxiv.org/abs/2607.09280v1)
  - *该论文研究中子星内部夸克物质与超子相互作用的理论模型，探讨其对中子星状态方程及最大质量的影响。*
- **[1]** [Effects of dark matter and magnetic field on neutron star properties in relativistic mean-field theory: A single-fluid approach](http://arxiv.org/abs/2607.09119v1)
  - *该论文利用相对论平均场理论研究了暗物质与磁场对中子星结构性质的影响，属于致密星核物理研究。*
- **[1]** [Fast Radio Bursts Trace Cosmic Star Formation with Little Delay](http://arxiv.org/abs/2607.09109v1)
  - *该研究通过分析CHIME/FRB数据，发现快速射电暴的发生率与宇宙恒星形成历史高度一致，支持其起源于年轻恒星遗迹（如磁星）。*
- **[1]** [Tentative detection of circularly polarized bursty radio emissions from the HD 189733 exoplanetary system using NenuFAR beamformed observations](http://arxiv.org/abs/2607.08910v1)
  - *本文利用NenuFAR射电望远镜对系外行星系统HD 189733进行观测，尝试探测并验证其圆偏振爆发射电辐射。*
- **[1]** [Magnetised Dense Nuclear Matter in Neutron Stars: A Relativistic Mean-Field Study of the Equation of State](http://arxiv.org/abs/2607.08850v1)
